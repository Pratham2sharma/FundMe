         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  ...
                  <a class="btn btn-sm elevation-2" href="add-campaign.php" style="margin-top: 20px;margin-left: 10px;background-color: #05445E;color: #ddd;"><i
                        class="fa fa-plus"></i>
                     Add New</a>
               </div>
            </div>
                     ...
                     <table id="example1" class="table table-bordered table-hover">
                        ...
                        <tbody>
                          <tr>
                           ...
                           <td>Php 50,000.00</td>
                           <td>Oct 30, 2021</td>
                             <td><img src="assets/img/logo.png" width="100" alt="User Image"></td>
