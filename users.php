      ...
      <div class="content-wrapper">
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0 text-dark"><span class="fa fa-user-tie"></span> Users</h1>
                  </div>
                  <div class="col-sm-6">
                  ...
                  <a class="btn btn-sm elevation-2" href="add-user.html" style="margin-top: 20px;margin-left: 10px;background-color: #05445E;color: #ddd;"><i
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 ...
                                 <p class="info"><small>Password: <b>***********</b></small></p>
                              </td>
                              <td class="text-right">
                           ...
                           <tr>
                              ...
                              <td>
                                 <p class="info">Username: <b>juan</b></p>
                                 <p class="info"><small>Password: <b>***********</b></small></p>
                              </td>
                              <td class="text-right">
                                 <a class="btn btn-sm btn-success" href="#" data-toggle="modal" data-target="#edit"><i
